      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="flex items-center font-display text-2xl font-semibold text-primary mb-4">
              BarterBank
            </Link>
            <p className="text-gray-600 dark:text-gray-400 max-w-md">
              A platform for bartering services and products as loan repayments, enabling flexible exchanges when cash is tight.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/loans" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">
                  Browse Loans
                </Link>
              </li>
              <li>
                <Link to="/create-loan" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">
                  Create Request
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 dark:text-gray-400 text-sm">
            &copy; {new Date().getFullYear()} BarterBank. All rights reserved.
          </p>
